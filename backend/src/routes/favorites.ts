...
router.put("/favorites/characters/:id", isAuthenticated, async (req, res) => {
...
router.put("/favorites/comics/:id", isAuthenticated, async (req, res) => {
...
router.delete("/favorites/comics/:id", isAuthenticated, async (req, res) => {
